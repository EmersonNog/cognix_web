...
export const ProductValueSection = forwardRef<HTMLElement, ProductValueSectionProps>(
  ...
  return (
    <section
      ...
      ref={ref}
      className="sticky top-0 z-10 flex min-h-[100svh] scroll-mt-24 items-start overflow-hidden bg-white px-5 pb-16 pt-16 text-[#060E20] sm:scroll-mt-28 sm:px-8 sm:pb-20 sm:pt-20 lg:h-[100svh] lg:min-h-0 lg:items-center lg:px-16 lg:pb-16 lg:pt-16"
    >
